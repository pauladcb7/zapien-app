// export const BASE = process.env.NODE_ENV === 'production' ? '/api' : 'http://localhost:3001/api/'
...
export const GET_MATERIAL_REQUISITION_BY_EMPLOYEE = 'material-requisition/getByEmployee'
